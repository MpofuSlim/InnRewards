...
public class ReportingController {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(name = "CSV", value = """
                                    ...
                                    22222222-3333-4444-5555-666666666666,2026-05-04T12:00:00Z,REDEMPTION,,-500.0000,b4c0d2e3-2345-6789-abcd-ef0123456789,c7d8e9f0-1234-5678-90ab-cdef12345678,d2c8f0a1-0123-4567-1234-567890123456,VOUCHER:482913760512,INV-1746355200000-4821
    ...
    @ApiResponses(@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "CSV stream",
            content = @Content(mediaType = "text/csv", examples = @ExampleObject(name = "CSV", value =
                    ...
                    + "d2c8f0a1-0123-4567-1234-567890123456,482913760512,REDEEMED,11111111-1111-1111-1111-111111111111,"
